        ...
        for (var i in listProduct) {
            ...
            <div class="card product p-2" style="width:auto"> <img class="card-img-top" src="${data.img1}">
                ...
                <div class="star_box float-left pt-2">
                    <span class="text-center btn add-to-cart btn-add-cart add-cart float-left col-5" data-id=" data.id" data-name=" data.name" data-img=" data.img" data-price=" data.price" onclick="checkorder(${data.id})">
                    <a>
                        <i class="fas fa-cart-plus"></i>Muahang
                    </a>
                </span>
...
function getProductById(id) {
    ...
    <b>Giá:${a.price} VNĐ </b>
    <br>
    <a class = "btn btn-outline-info btn-detail" onclick = "ths()" >Mua</a>
        `;
